...
def parse_args(args=None):
    ...
    parser.add_argument('--input_long_dir', default='./data/raw/long.jsonl', type=str)
    parser.add_argument('--input_share_dir', default='./data/sharegpt.jsonl ', type=str)
    parser.add_argument('--output_dir', default='./', type=str)

    return parser.parse_args(args)

def process_file(lines, rank, save_dir, args):
    ...
    try:
        ...
        if args.model == 'chatglm':
            ...
            tokenizer = LlamaTokenizer.from_pretrained("/mnt/public/shuzhengsi/ppl/models/models--THUDM--LongAlign-7B-64k-base/snapshots/fa28d013fed955d0e573196de081c3025fb3dbe4", trust_remote_code=True)
...
def main(args):
    ...
    save_dir = './multiprocess/multiprocess_data' + '_' + final_dir.split('/')[-1]
    ...
    if args.input_share_dir == '0':
        short = []
    else:
        short = open(args.input_share_dir, encoding='utf-8').readlines()
        
    long = open(args.input_long_dir, encoding='utf-8').readlines()
    ...
    elif args.datanum == '3k':
        lines = short + long[:3000]
    elif args.datanum == '1k':
        lines = short + long[:1000]
    lines = short + long
    ...
    for i in range(PROC_NUM):
        ...
        pool.apply_async(process_file, args=(lines[start_line:end_line], i, save_dir, args))

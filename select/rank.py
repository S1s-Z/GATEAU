...
if __name__ == '__main__':
    ...
    args = parse_args()
    base_json_file_path = "./data/HMG_4k.jsonl"
    long_json_file_path = "./data/HMG_64k.jsonl"
    ppl_json_file_path = "./data/cas.jsonl"
    ...
    for i in range(len(data_long)):
        ...
        # set your own alpha 
        final_score = args.alpha * ppl_score + (1-args.alpha) * align_score
